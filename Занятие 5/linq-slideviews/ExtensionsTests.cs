...
public class ExtensionsTests
{
	...
	public void MedianOfEmptyList_Fails()
	{
		Assert.Throws<InvalidOperationException>(
			() => new double[0].GetMedian());
	}

	[Test]
	public void MedianOfSingleItemList()
	{
		var actual = new[] { 42.0 }.GetMedian();
	...
	{
		var actual = new[] { 1.0, 2.0 }.GetMedian();
	...
	{
		var actual = new[] { 1.0, 2.0, 3000.0 }.GetMedian();
	...
	{
		var actual = new[] { 1.0, 1.0, 1.0, 2.0, 3.0 }.GetMedian();
